...
- [x] 02-01: Create validateStudent middleware using express-validator, enforce constraints, and implement filter routes.
...
- [x] 04-01: Implement modal overlays, search/filter listeners, stats logic, and wire confirmation dialogs.
