...
- [ ] **Phase 1: Project setup & dual database connection** - Establish dependencies, environments, Mongoose setup, and SQLite auto-initialization.
...
Plans:
- [ ] 01-01: Set up config files, MongoDB connection, better-sqlite3 database initialization, and Git/env parameters.
...
Plans:
- [ ] 03-01: Implement Student mongoose model, student controller, routes, and link with auth middleware.
...
|-------|----------------|--------|-----------|
| 1. Project setup & DB | 0/1 | Not started | - |
